...
if(!/from\('players'\)\.update\(\{full_name:canonicalPlayerName\(item\.full_name\)/.test(fn)) throw new Error('existing player full_name must be refreshed from canonical SportAdmin name');
