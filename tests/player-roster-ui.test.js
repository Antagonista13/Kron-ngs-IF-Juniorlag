...
assert.ok(index.includes('player-roster.css?v=6'), 'roster css cache version must be bumped for the mobile admin-card fix');
assert.ok(index.includes('player-roster.js?v=6'), 'roster js version must remain current');
