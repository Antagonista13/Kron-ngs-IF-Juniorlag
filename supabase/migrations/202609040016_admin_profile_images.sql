...
using (bucket_id='profile-images' and public.current_profile_active());
...
with check (bucket_id='profile-images' and public.current_profile_role()='admin' and public.current_profile_active());
...
using (bucket_id='profile-images' and public.current_profile_role()='admin' and public.current_profile_active())
with check (bucket_id='profile-images' and public.current_profile_role()='admin' and public.current_profile_active());
