...
function loadCompactAdminUx(){
  if(!document.querySelector('link[data-admin-compact-users]')){const link=document.createElement('link');link.rel='stylesheet';link.href='admin-compact-users.css?v=2';link.dataset.adminCompactUsers='true';document.head.appendChild(link);}
  if(!document.querySelector('script[data-admin-compact-users]')){const script=document.createElement('script');script.src='admin-compact-users.js?v=3';script.dataset.adminCompactUsers='true';document.head.appendChild(script);}
}
