...
function loadCompactAdminUx(){
  ...
  if(!document.querySelector('script[data-admin-compact-users]')){const script=document.createElement('script');script.src='admin-compact-users.js?v=2';script.dataset.adminCompactUsers='true';document.head.appendChild(script);}
}
