...
function ensureCoachLayoutStyles() {
  ...
  style.textContent = `
    #coachDevelopmentView.coach-workspace { background: transparent; box-shadow: none; padding: 0; }
    .coach-workspace > h2 { margin-bottom: 6px; }
    .coach-workspace > p { color: #666; margin-top: 0; margin-bottom: 18px; }
    .coach-tool-card { background: #fff; border: 1px solid #e5e5e5; border-radius: 18px; padding: 20px; margin: 0 0 18px; box-shadow: 0 5px 16px rgba(0,0,0,0.06); }
    ...
    .coach-player-button { border: 1px solid #111; background: #fff; color: #111; border-radius: 10px; padding: 10px 14px; font-weight: 700; cursor: pointer; }
    .coach-player-button:hover, .coach-player-button:focus { background: #111; color: #fff; }
    .coach-context-card p { line-height: 1.5; }
    .coach-feedback-block { margin-top: 20px; padding-top: 18px; border-top: 1px solid #d8d8d8; }
    .coach-feedback-block h4 { font-size: 18px; margin: 0 0 12px; }
    .coach-feedback-block textarea, .coach-comment { width: 100%; border: 1px solid #cfcfcf; border-radius: 10px; padding: 11px; font: inherit; resize: vertical; margin-bottom: 10px; }
