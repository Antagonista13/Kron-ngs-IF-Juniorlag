  ...
  try {
    ...
    if (!nextActivity) {
      ...
      homeActivity.innerHTML = `
        ...
        <div>
          <strong>Inga aktiviteter</strong>
          <p>Inget planerat just nu.</p>
        </div>
      `;
    ...
    if (
      ...
      title.toLowerCase().includes("träning")
    ) {
...
/* Ladda nästa aktivitet när appen öppnas */
