(function(root){
  ...
  async function setup(){if(ready||!root.kronangSupabase||!root.document)return;role=await currentRole();if(role !== 'admin')return;ready=true;document.addEventListener('click',rememberFromEvent,true);document.addEventListener('keydown',rememberFromEvent,true);const observer=new MutationObserver(function(){if(document.querySelector('.player-public-profile')&&lastPlayerId)decorate();});observer.observe(document.body,{childList:true,subtree:true});}
